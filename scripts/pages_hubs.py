...
# ─────────────────────────────────────────────
# 매거진 글 하단 — 내부 링크 (글당 3~4개, 핵심만)
# ─────────────────────────────────────────────
MAGAZINE_INTERNAL = {
    "regional-trend-2026-h1": {
        "h2":"권역별 단가·신축 트렌드를 더 깊게 — 함께 보면 좋은 자료",
        "intro":"본 보고서에 인용된 권역·업종·계약·안전 기준은 다음 자료에서 더 자세히 다룹니다.",
        "links":[
            ("2026 마사지 관리사 급여 가이드","/magazine/salary-guide-2026/"),
            ("신규 오픈 샵을 어떻게 평가할까","/magazine/newcomer-shop-guide/"),
            ("프리랜서 계약 체크리스트 9가지","/magazine/contract-checklist/"),
            ("서울 강남구 마사지 구인구직","/locations/seoul/gangnam/"),
        ],
    },
    "salary-guide-2026": {
    ...
    "shop-vs-freelance": {
        ...
        "links":[
            ("2026 마사지 관리사 급여 가이드","/magazine/salary-guide-2026/"),
            ("프리랜서 계약 체크리스트 9가지","/magazine/contract-checklist/"),
            ("서울 강남 출장 라인 매물·채용","/locations/seoul/gangnam/"),
        ],
    },
    "safe-workplace": {
    ...
    "regional-trend-2026-h1": [
        ("방법론 — 16개월 매칭 데이터 + 신축 64곳 현장 교차 검증",
         ["본 보고서는 2025년 1월부터 2026년 5월까지 16개월간 누적된 자체 매칭 로그 23,700건과, 2026년 1~5월 사이 전국에서 새로 오픈한 마사지샵 64곳을 운영팀이 직접 확인한 1차 자료를 결합해 작성되었습니다.",
          ...
          "전국 평균치 중심의 종합 분석은 <a href=\"/magazine/salary-guide-2026/\">2026 마사지 관리사 급여 가이드</a>에서 함께 확인하실 수 있습니다."]),
        ("권역별 신축 비중 — 서울 강남이 27%로 최대",
         ["64곳의 신축 샵 가운데 서울 강남구가 17곳(27%)으로 가장 많았고, 분당·판교 9곳(14%), 부산 해운대 8곳(13%), 동탄 6곳(9%), 송도·미사 각 4곳(6%) 순으로 집계되었습니다.",
          "강남은 객단가 10만원 이상 프리미엄 라인이 12곳에 달해, 신축 비중뿐 아니라 가격대 자체에서도 압도적입니다. 권역별 상권·고객층은 <a href=\"/locations/seoul/gangnam/\">서울 강남구</a>, <a href=\"/locations/seoul/seocho/\">서초구</a>, <a href=\"/locations/busan/haeundae/\">부산 해운대구</a> 페이지에 권역별 시세와 함께 정리되어 있습니다."]),
        ("신축 vs 기성 단가 차이 — 평균 +14%, 단 6개월 후 정상화",
        ...
        ("신축 샵 입사 전 — 시스템·정산·인원 3가지 체크",
         ["신축 샵은 단가 프리미엄이 매력적이지만, 운영 미숙으로 인한 정산 분쟁·동선 혼란 리스크도 함께 안고 있습니다. 면접 단계에서 최소 세 가지는 반드시 확인하시기 바랍니다.",
          ...
          "셋째, 함께 일할 관리사 수와 견습 과정의 유무입니다. 자세한 평가 항목은 <a href=\"/magazine/newcomer-shop-guide/\">신규 오픈 샵 평가 가이드</a>, 계약서에서 반드시 짚어야 할 9가지는 <a href=\"/magazine/contract-checklist/\">프리랜서 계약 체크리스트</a>에 정리되어 있습니다."]),
        ...
        ("앞으로 6개월 — 어디로 흐름이 이동할까",
         ["첫째, 신축 강세는 동탄2·미사·송도 라인으로 빠르게 확산 중이며, 2026년 7~9월 사이 추가로 30곳 이상이 오픈할 것으로 예상됩니다.",
          "둘째, 권역별 광고 등급(VVIP·VIP·프리미엄)의 분포 변화는 단가 흐름의 선행 지표로 활용할 수 있습니다. <a href=\"/jobs/\">전체 채용 공고</a>에서 일급·인센티브·정산 주기를 직접 확인해보시기 바랍니다.",
          "셋째, 외국인 응대 라인은 강남·해운대를 넘어 송도·이태원·송파 권역까지 확대될 전망이며, 응대 가능 관리사의 단가 프리미엄이 더 커질 가능성이 큽니다.",
          "마지막으로, 권역과 무관하게 안전·계약의 기본기는 동일하게 중요합니다. 신규 입직자라면 운영팀 공식 자료인 <a href=\"/notices/newcomer-safety/\">신규 입직자 안전 가이드</a>를 가장 먼저 읽어 보시기를 권합니다."])
    ],
    "salary-guide-2026": [
